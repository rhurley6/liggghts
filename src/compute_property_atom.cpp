  ...
  for (int iarg = 3; iarg < narg; iarg++) {
    ...
    if (strcmp(arg[iarg],"id") == 0) {
      ...
      if (!atom->quat_flag)
        error->all(FLERR,"Compute property/atom for "
                   "atom property that isn't allocated");
      pack_choice[i] = &ComputePropertyAtom::pack_sphquat0;
    } else if (strcmp(arg[iarg],"sphquat1") == 0) {
      if (!atom->quat_flag)
        error->all(FLERR,"Compute property/atom for "
                   "atom property that isn't allocated");
      pack_choice[i] = &ComputePropertyAtom::pack_sphquat1;
    } else if (strcmp(arg[iarg],"sphquat2") == 0) {
      if (!atom->quat_flag)
        error->all(FLERR,"Compute property/atom for "
                   "atom property that isn't allocated");
      pack_choice[i] = &ComputePropertyAtom::pack_sphquat2;
    } else if (strcmp(arg[iarg],"sphquat3") == 0) {
      if (!atom->quat_flag)
        error->all(FLERR,"Compute property/atom for "
                   "atom property that isn't allocated");
      pack_choice[i] = &ComputePropertyAtom::pack_sphquat3;
...
void ComputePropertyAtom::pack_sphquat0(int n)
{
...
void ComputePropertyAtom::pack_sphquat1(int n)
{
  double **quat = atom->quat;
  int *mask = atom->mask;
  int nlocal = atom->nlocal;
...
void ComputePropertyAtom::pack_sphquat2(int n)
{
  double **quat = atom->quat;
  int *mask = atom->mask;
  int nlocal = atom->nlocal;
...
void ComputePropertyAtom::pack_sphquat3(int n)
{
  double **quat = atom->quat;
  int *mask = atom->mask;
  int nlocal = atom->nlocal;
