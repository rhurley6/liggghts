  ...
  while (iarg < narg) {
    ...
    if (strcmp(arg[iarg],"id") == 0) {
      ...
      if (!atom->quat_flag)
        error->all(FLERR,
                   "Fix store/state for atom property that isn't allocated");
      pack_choice[nvalues++] = &FixStoreState::pack_sphquat0;
    } else if (strcmp(arg[iarg],"sphquat1") == 0) {
      if (!atom->quat_flag)
        error->all(FLERR,
                   "Fix store/state for atom property that isn't allocated");
      pack_choice[nvalues++] = &FixStoreState::pack_sphquat1;
    } else if (strcmp(arg[iarg],"sphquat2") == 0) {
      if (!atom->quat_flag)
        error->all(FLERR,
                   "Fix store/state for atom property that isn't allocated");
      pack_choice[nvalues++] = &FixStoreState::pack_sphquat2;
    } else if (strcmp(arg[iarg],"sphquat3") == 0) {
      if (!atom->quat_flag)
        error->all(FLERR,
                   "Fix store/state for atom property that isn't allocated");
      pack_choice[nvalues++] = &FixStoreState::pack_sphquat3;
...
void FixStoreState::pack_sphquat1(int n)
{
...
void FixStoreState::pack_sphquat2(int n)
{
  double **quat = atom->quat;
  int *mask = atom->mask;
  int nlocal = atom->nlocal;
...
void FixStoreState::pack_sphquat3(int n)
{
  double **quat = atom->quat;
  int *mask = atom->mask;
  int nlocal = atom->nlocal;
...
void FixStoreState::pack_sphquat0(int n)
{
  double **quat = atom->quat;
  int *mask = atom->mask;
  int nlocal = atom->nlocal;
