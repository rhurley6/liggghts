...
class Atom : protected Pointers {
 public:
  ...
  int *molecule;
  double *q,**mu;
  double **omega,**quat,**angmom,**torque;
...
//------------------------------------------------------
  ...
  int sphere_flag,qsphere_flag,ellipsoid_flag,line_flag,tri_flag,body_flag;
  ...
  int rmass_flag,radius_flag,omega_flag,quat_flag,torque_flag,angmom_flag;
