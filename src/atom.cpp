...
//------------------------------------------------------
  ...
  sphere_flag = qsphere_flag = ellipsoid_flag = line_flag = tri_flag = body_flag = 0;
  superquadric_flag = 0;
...
void Atom::create_avec(const char *style, int narg, char **arg, char *suffix)
{
  ...
  sphere_flag = qsphere_flag = ellipsoid_flag = line_flag = tri_flag = 0;
  peri_flag = electron_flag = 0;

  molecule_flag = q_flag = mu_flag = 0;
  rmass_flag = radius_flag = omega_flag = quat_flag = torque_flag = angmom_flag = 0;
  density_flag = 0; 
  rho_flag = p_flag = 0; 
  vfrac_flag = spin_flag = eradius_flag = ervel_flag = erforce_flag = 0;
