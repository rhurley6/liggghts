...
AtomStyle(qsphere,AtomVecQSphere)

AtomStyle(granular,AtomVecQSphere) 

#else

#ifndef LMP_ATOM_VEC_QSPHERE_H
#define LMP_ATOM_VEC_QSPHERE_H

#include "atom_vec.h"

namespace LAMMPS_NS {

class AtomVecQSphere : public AtomVec {
 public:
  AtomVecQSphere(class LAMMPS *);
  ~AtomVecQSphere() {}
  void init();
  void grow(int);
  void grow_reset();
