...
FixStyle(particletemplate/qsphere,FixTemplateQSphere)

#else

#ifndef LMP_FIX_TEMPLATE_QSPHERE_H
#define LMP_FIX_TEMPLATE_QSPHERE_H
...
class FixTemplateQSphere : public Fix {
 public:

  FixTemplateQSphere(class LAMMPS *, int, char **);
  ~FixTemplateQSphere();
